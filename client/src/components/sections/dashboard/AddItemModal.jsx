...
export const AddItemModal = ({ isOpen, onClose, type, item, onAdd, isSubmitting }) => {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end gap-4 mt-6">
            <button
              ...
              className="px-4 py-2 bg-gray-700/50 text-white rounded-lg hover:bg-gray-600/50 transition-colors disabled:opacity-50"
            >
              Cancel
            </button>
            <button
